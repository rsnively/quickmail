...
$string['disclaimer_help'] = 'This disclaimer will appear on the email page. The current disclaimer is: {$a}';
$string['disclaimer_text'] = 'BE SURE TO GET THIS FROM BUDDY AND WHEN YOU DO UPDATE THE CODE';
